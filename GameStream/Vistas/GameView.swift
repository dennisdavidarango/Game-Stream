...
//  GameStream
//
//  Created by Dennis David Arango Mendieta on 14/04/22.
//
        ...
        ZStack {
            ...
            VStack {
                ...
                ScrollView{
                    ...
                    videoInfo(titulo: titulo, url: url, studio: studio, calificacion: calificacion, anoPublicacion: anoPublicacion, descripcion: descripcion, tags: tags).padding(.bottom)
...
struct videoInfo : View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading ){
            ...
            Text("\(descripcion)")
                .foregroundColor(.white).font(.subheadline).padding(.top, 5).padding(.leading)
